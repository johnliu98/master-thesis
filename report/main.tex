...
\begin{equation}\begin{split}
    \min_{u \in \U} \quad &x_N^T Q_N x_N + \sum_{k=0}^{N-1} x_k^T Q x_k + u_k^T R u_k \\
    \text{s.t.} \quad &x_{k+1} = f(x_k, u_k), \quad \text{for} \quad k = 0, 1, \dots, N-1 \\
    &(x_k, u_k) \in \X \times \U, \quad \text{for} \quad k = 0, 1, \dots, N-1 \\
    &x_N \in \X_N
